...
format: 
  revealjs:
    author-steffi: true
    title: "Introduction to Quarto <br> for Reproducibility"
    subtitle: UNBC Applied Analysis Hub
    date: today
    date-format: iso
    title-slide-attributes: 
      data-background-image: figures/hex_quarto.png
...
```{r}
my_data <- read_csv(
  "https://raw.githubusercontent.com/steffilazerte/NRI_7350/main/data/chorus.csv"
)
my_data
```
...
![](figures/report.png){fig-alt="Screenshot of a webpage with a table of contents on the left, nicely formated text explaining the visual threshold calculations and a series of plots below"}
...
![R](figures/R.png){fig-alt=""}

![RStudio](figures/RStudio-Ball.png){fig-alt=""}
:::
...
- `fig-alt` **Alt**ernative text for screen readers helping those who can't see the figure 
   (should be descriptive, not the same as a caption)[^1] 
...
[^1]: More alt text resources: [when to include](https://www.w3.org/WAI/tutorials/images/decision-tree/); [how to write](https://www.w3.org/WAI/tutorials/images/informative/); the [importance of context](https://archive.ph/MnUEL)
...
Use the more advanced [template](https://steffilazerte.ca/intro_to_quarto/example.qmd)
...
[See `example_spin.R`](https://steffilazerte.ca/intro_to_quarto/example_spin.R)
:::
...
:::{.absolute .small top=0 right=0}
([Quarto Docs for Websites](https://quarto.org/docs/websites/))
:::

:::: {.columns}

:::{.column width=50%}
Vulture Migration ([GitHub](https://github.com/steffilazerte/vulture_migration) | [Website](https://steffilazerte.ca/vulture_migration/))
![](figures/vultures.png)
:::

:::{.column width=50%}
Urban Migration Stopovers ([GitHub](https://github.com/steffilazerte/urban_motus/) | [Website](https://steffilazerte.ca/urban_motus))
![](figures/motus.png)
:::
::::
...
:::{.absolute .small top=0 right=0}
([Quarto Docs for Manuscripts](https://quarto.org/docs/manuscripts/))
:::

Effects of Riparian Grazing on Distinct Water-Extractable Phosphorus Sources ([GitHub](https://github.com/alex-koiter/riparian-grazing-manuscript) | [Website](https://alexkoiter.ca/riparian-grazing-manuscript/))

:::{layout-ncol=2}
![The manuscript](figures/grazing.png){fig-alt=""}

![A notebook associated with the manuscript](figures/notebook.png){fig-alt=""}
:::
...
- [This presentation](https://github.com/steffilazerte/intro_to_quarto)
...
:::{.fragment fragment-index=1 .absolute top=45% right=0 width=30%}
### Thank you! 

[*Please fill out this [feedback form](https://forms.gle/VTHRDt6eQxkbnyZz9)*]{.small}
